...
const MsgCountPendingIconRoot = styled.div.withConfig({ displayName: "MsgCountPendingIconRoot", componentId: "sc-jvni2o" }) `
    color: ${props => props.theme.colors.msgCountPendingIcon};
`;
export class MsgCountPendingIcon extends React.Component {
    render() {
        return (React.createElement(MsgCountPendingIconRoot, null,
            React.createElement(SvgIcon, Object.assign({}, this.props),
                React.createElement("g", { stroke: "none", strokeWidth: "1", fill: "none", fillRule: "evenodd" },
                    React.createElement("path", { d: "M12,6 C11.1715729,6 10.5,5.32842712 10.5,4.5 C10.5,3.67157288 11.1715729,3 12,3 " +
                            ...
                            "L5.01,21 C3.9,21 3,20.1 3,19 Z", fill: "currentColor", fillRule: "nonzero" })))));
    }
}
//# sourceMappingURL=MsgCountPendingIcon.js.map