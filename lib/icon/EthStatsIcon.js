...
`;
export class EthStatsIcon extends React.PureComponent {
    render() {
        return React.createElement(SvgIconEncoded, { size: this.props.size, viewBoxSize: 32 }, getIconSvg(this.props.color));
    }
}
//# sourceMappingURL=EthStatsIcon.js.map