...
import { Bar } from "../Bar";
const Placeholder = styled("div").withConfig({ displayName: "Placeholder", componentId: "sc-14tew0b" }) `
...
`;
const HorizontalBarRoot = styled(Bar).withConfig({ displayName: "HorizontalBarRoot", componentId: "sc-12ju0ac" }) `
    height: ${props => props.height}px;
